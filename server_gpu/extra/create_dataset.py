...
if __name__ == "__main__":
    ...
    with open(f"{dir}/train.source", 'w') as f:
        f.writelines("%s\n" % l for l in train_source)

    with open(f"{dir}/train.target", 'w') as f:
        f.writelines("%s\n" % l for l in train_target)

    with open(f"{dir}/val.source", 'w') as f:
        f.writelines("%s\n" % l for l in val_source)

    with open(f"{dir}/val.target", 'w') as f:
        f.writelines("%s\n" % l for l in val_target)
